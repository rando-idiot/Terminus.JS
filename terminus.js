...
function info() {
	return `Note that this game is played entirely in the js console.
Use update(); to update your monies.
fyi some mechanics of this game rely on update(); being manyally used so no, this isn't an idle game.
use shop(); to see the main shop
do infshop(); to view unlimitedly purchasable upgrades.`;
}
